...
from app.api.common import PageParams, get_active_or_400, get_active_or_404, pagination, paginated, search_filter
...
def list_faculties(
    ...
    if search:
        query = query.filter(search_filter(Faculty.name, search))
